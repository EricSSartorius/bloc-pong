...
(function() {
  var Ball, Computer, Paddle, Player, animate, ball, canvas, computer, context, height, move, player, render, step, update, width;
  ...
  Player = function() {
    return this.paddle = new Paddle(10, canvas.height / 2 - 50, 10, 100);
  };

  Computer = function() {
    return this.paddle = new Paddle(620, canvas.height / 2 - 50, 10, 100);
  };
  ...
  Ball = function(x, y) {
    ...
    this.radius = 10;
    this.x_speed = 3;
    return this.y_speed = Math.floor(Math.random() * (3 + 3 + 1)) + -3;
  };
